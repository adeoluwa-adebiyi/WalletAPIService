...
class InitDb1619526534262 {
    constructor() {
        this.name = 'InitDb1619526534262';
    }
    async up(queryRunner) {
        ...
        await queryRunner.query(`CREATE TABLE "user" ("id" SERIAL NOT NULL, "firstName" character varying, "email" character varying NOT NULL, "passwordHash" character varying NOT NULL, "lastName" character varying, "dob" TIMESTAMP, "verified" boolean NOT NULL DEFAULT false, "suspended" boolean NOT NULL DEFAULT false, "createdAt" TIMESTAMP WITH TIME ZONE NOT NULL DEFAULT CURRENT_TIMESTAMP, "updatedAt" TIMESTAMP WITH TIME ZONE NOT NULL DEFAULT CURRENT_TIMESTAMP, CONSTRAINT "UQ_e12875dfb3b1d92d7d7c5377e22" UNIQUE ("email"), CONSTRAINT "PK_cace4a159ff9f2512dd42373760" PRIMARY KEY ("id"))`);
...
exports.InitDb1619526534262 = InitDb1619526534262;
//# sourceMappingURL=1619526534262-InitDb.js.map